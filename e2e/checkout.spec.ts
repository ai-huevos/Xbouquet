...
test.describe('Checkout Flow Tests', () => {
    ...
    test('Full Add to Cart and Checkout Redirect', async ({ page }) => {
        ...
        await page.click('text="Add Product"'); // Assuming there's a button, need to verify selector or just use url
        ...
        await page.fill('input[name="password"]', 'password123');
        await page.selectOption('select[name="role"]', 'shop');
        await page.waitForLoadState('networkidle'); // Ensure hydration
        await page.click('button[type="submit"]');
        ...
        // Click the product name to navigate to the detail page
        await page.click('text="Test E2E Rose"');
